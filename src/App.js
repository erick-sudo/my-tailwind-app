  ...
  return (
    ...
    <div className="App  sm:flex sm:flex-wrap sm:items-center sm:justify-items-start bg-sky-300">
      ...
      <div className='py-8 px-8 max-w-sm mx-auto my-1 bg-white shadow-lg rounded-xl sm:py-4 sm:flex sm:items-center sm:space-y-0 sm:space-x-6 border'>
        <img className='block mx-auto h-24 rounded-full sm:mx-0 sm:shrink-0' src={dp} alt="Woman's Face" />
    ...
    <h1 className="shadow-md w-90 bg-emerald-700 m-4 shadow-red-900 h-32 font-bolder text-white flex justify-center items-center text-4xl drop-shadow-lg decoration-purple-700">Moringa School</h1>
    <form className='bg-white/80 max-w-xs mx-auto p-3'>
      ...
      <div className='bg-transparent flex items-center p-4'>
        <img className='h-12 ring-4 ring-amber-700 rounded-full' src={dp} />
        <label className='bg-transparent'>
          <input type="file" name="photo" className='text-sm file:mr-4file-py-2 file:px-4 file:ml-4 w-full file:rounded-full file:border-0 file:text-violet-700 hover:file:bg-violet-100 file:border file:border-solid' />
        </label>
      </div>
    </form>
